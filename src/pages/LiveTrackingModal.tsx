...
export function LiveTrackingModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-[999] flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-[1150px] rounded-lg p-5 text-[#111827]">
          ...
          <div className="border rounded-lg p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="inline-flex mt-3 px-3 py-1 rounded-md bg-pink-100 text-pink-600 text-xs">
                  Truck ID: TRK-4582
                </span>
              </div>
            </div>
  ...
  return (
    <div className="group flex items-center justify-between relative">
      <div className="flex items-center gap-2">
        ...
        <span className="text-[16px]">56743</span>
      </div>
      ...
      <div className="absolute left-0 top-[-85px] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-20">
        <div className="relative bg-[#3D3D3D] text-white rounded-md px-6 py-4 min-w-[340px]">
