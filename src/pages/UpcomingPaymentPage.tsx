...
const SORT_OPTIONS = [
  "Settlement Week(Earliest)",
  "Settlement Week(Latest)",
  "Net Paid (highest first)",
  "Net Paid (Lowest first)",
] as const;
...
function StatCard({
  ...
  return (
    <div className="bg-white border flex items-center border-[#E5E7EB] rounded-xl px-4 py-4 shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]">
...
export default function UpcomingPaymentPage() {
  ...
  return (
    <div className="bg-[#F3F4F6]">
      ...
      <div className="bg-white rounded-xl border border-[#E5E7EB] px-5 py-4 mb-5 grid xl:grid-cols-5 sm:grid-cols-2 grid-cols-1 gap-4 items-center">
      ...
      <div className="bg-white rounded-xl border border-[#E5E7EB] overflow-hidden">
        <div className="flex sm:items-center gap-3 flex-col sm:flex-row justify-between px-5 py-3.5 border-b border-[#E5E7EB]">
