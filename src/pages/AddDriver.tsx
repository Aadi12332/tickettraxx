  ...
  return (
    <div className="relative flex flex-col">
      ...
      <input
        ...
        className={`w-full px-3 py-[14px] text-[13px] rounded-md border outline-none transition-all
  ...
  return (
    <div className="relative flex flex-col">
      ...
      <select
        value={value}
        onChange={(e) => onChange(e.target.value)}
        className={`w-full px-3 py-[14px] text-[13px] rounded-md border outline-none appearance-none bg-white cursor-pointer
