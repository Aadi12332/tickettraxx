...
function StatCard({
  ...
  return (
    <div className="bg-white rounded-xl border border-[#E5E7EB] px-4 py-4 flex items-center justify-between gap-3 min-w-0 shadow-[0px_1px_2px_-1px_#0000000D,0px_1px_3px_0px_#0000000D]">
      <div className="flex items-center gap-2 min-w-0">
        <div className="w-11 h-11 rounded-lg bg-[#EFF6FF] border border-[#BFDBFE] flex items-center justify-center flex-shrink-0">
          {icon}
        </div>
    ...
    <div className="bg-[#F3F4F6]">
      ...
      <div className="grid xl:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-4 mb-5">
        <StatCard
          ...
          trendBg="#F3E8FF"
          trendColor="#9333EA"
          icon={<ReceiptText size={18} className="text-[#1D3461]" />}
        />
        <StatCard
          ...
          trendBg="#FFEDD5"
          trendColor="#EA580C"
          icon={<Notebook size={18} className="text-[#1D3461]" />}
        />
        <StatCard
          ...
          trendBg="#F1F5F9"
          trendColor="#475569"
          icon={<FileCheck size={18} className="text-[#1D3461]" />}
        />
        <StatCard
      ...
      <div className="bg-white rounded-lg border border-[#E5E7EB] px-5 py-4 mb-5 xl:grid-cols-4 sm:grid-cols-2 grid-cols-1 grid items-center gap-4">
